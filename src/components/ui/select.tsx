  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "rounded-xl border border-teal-900/19 bg-white/95",
        "px-3.5 py-2.75 font-[inherit] text-[0.95rem] text-[#0d2230]",
        "transition-[border-color,box-shadow] duration-160 ease-out",
        "data-placeholder:text-[#506071]/60",
        "focus:outline-none focus:border-emerald-700/70 focus:shadow-[0_0_0_3px_rgba(17,122,101,0.13)]",
        "disabled:cursor-not-allowed disabled:opacity-60",
        "[&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        "data-[size=sm]:rounded-lg data-[size=sm]:px-2 data-[size=sm]:py-1 data-[size=sm]:text-xs",
        className,
      )}
      {...props}
    >
