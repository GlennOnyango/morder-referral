...
const OrganizationWorkspacePage = () => {
  ...
  const pendingInviteRows: PendingInviteRow[] = pendingInvites.map((invite) => ({
        ...
        cell: ({ row }) => (
          <Select
            ...
            onValueChange={(val) => {
              ...
              setAssignRoleValues((prev) => ({ ...prev, [row.original.email]: val }));
        ...
        <CardContent className="flex items-start justify-between gap-3 px-5 py-4">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-sm text-slate-500">
              Facility workspace — manage staff, roles, and invitations.
            </p>
          </div>
